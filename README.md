# Android Instana Agent <a href="https://bintray.com/instana/public-maven"><img alt="Bintray" src="https://img.shields.io/badge/jcenter-1.1.4-brightgreen?color=0db4b3">
...
```groovy
dependencies {
    implementation 'com.instana:android-agent-runtime:1.1.4'
}
```
...
buildscript {
    ...
    dependencies {
        classpath "com.instana:android-agent-plugin:1.1.4"
    }
}
```
