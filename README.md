...
```groovy
dependencies {
    implementation 'com.instana:android-agent-runtime:3.6.2'
}
```
...
buildscript {
    ...
    dependencies {
        classpath "com.instana:android-agent-plugin:3.6.2"
    }
}
```
