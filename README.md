...
```groovy
dependencies {
    implementation 'com.instana:android-agent-runtime:4.5.2'
}
```
...
buildscript {
    ...
    dependencies {
        classpath "com.instana:android-agent-plugin:4.5.2"
    }
}
```
