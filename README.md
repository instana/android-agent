...
```groovy
dependencies {
    implementation 'com.instana:android-agent-runtime:4.6.1'
}
```
...
buildscript {
    ...
    dependencies {
        classpath "com.instana:android-agent-plugin:4.6.1"
    }
}
```
